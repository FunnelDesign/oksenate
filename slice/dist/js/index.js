    ...
    value: function customClick() {
      ...
      $(document).on('click touch', function (e) {
        ...
        if ($ev.closest('.hashLink').length || $ev.hasClass("hashLink")) {
          ...
          var adminMenu = $("body").css('padding-top');
