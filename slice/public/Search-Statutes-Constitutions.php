...
<!--      </div>-->
      ...
      <div class="section__v-inner section__v-inner_d">
        <div class="bContainer">
          ...
          <div class="pageIn__ico">
            <img src="../dist/images/titleIco/title-ico-14.png"
                 srcset="../dist/images/titleIco/title-ico-14-2x.png 2x">
          </div>

          <div class="bTitle bTitle_wSub_a">
            <h1>Search Statutes & Constitutions</h1>
          </div>
    ...
    <section class="section">
      <div class="bTiles bTiles_search">
        <div class="bTiles__items">

          <div class="bTiles__item">
            <div class="bTiles__title">
              Constitutions
            </div>
            <div class="form f-search f-search_min f-search_s_a f-search_throbber_show">
              <div class="form-item">
      ...
      <div class="bContainer">
        ...
        <div class="bTitle bTitle_gap_c">
          <div class="bTitle__sub bTitle__sub_b">
            <p>Documents 1 to 1 of 1 matching the query "1-2".</p>
          </div>
        </div>

        <div class="bColumns bColumns_2 bWrap bWrap_size_b bColumns_gap_a">
        ...
        <nav class="pager" role="navigation" aria-labelledby="pagination-heading">
          ...
          <ul class="pager__items js-pager__items">
            <li class="pager__item pager__item--first">
              <a href="?keys=senator&amp;page=0" title="Go to first page">
                <span class="visually-hidden">First page</span>
                <span aria-hidden="true">« First</span>
              </a>
            </li>
            <li class="pager__item pager__item--previous">
              <a href="?keys=senator&amp;page=0" title="Go to previous page" rel="prev">
                <span class="visually-hidden">Previous page</span>
                <span aria-hidden="true">‹ Previous</span>
              </a>
            </li>
            <li class="pager__item">
              <a href="?keys=senator&amp;page=0" title="Go to page 1">
            <span class="visually-hidden">
              Page
            </span>1</a>
            </li>
            <li class="pager__item is-active">
              <a href="?keys=senator&amp;page=1" title="Current page">
            <span class="visually-hidden">
              Current page
            </span>2</a>
            </li>
            ...
            <li class="pager__item pager__item--next">
              <a href="?keys=senator&amp;page=2" title="Go to next page" rel="next">
