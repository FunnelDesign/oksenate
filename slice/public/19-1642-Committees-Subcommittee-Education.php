<!DOCTYPE html>
<html>
<?php $title = '19-1642-Committees-Subcommittee-Education'; ?>
  ...
  <div class="pageIn">
      ...
      <div class="section__v-inner section__v-inner_c">
        <div class="bContainer">
          <div class="pageIn__ico">
            <img src="../dist/images/titleIco/title-ico-5.png" srcset="../dist/images/titleIco/title-ico-5-2x.png 2x" alt="">
          </div>
    ...
    <section class="section section_ind_c section_bg-color_c">
      ...
      <div class="bContainer">
        ...
        <div class="pageIn__ico">
          <img src="../dist/images/titleIco/title-ico-6.png" srcset="../dist/images/titleIco/title-ico-6-2x.png 2x" alt="">
        </div>
        <h2>Agencies</h2>
