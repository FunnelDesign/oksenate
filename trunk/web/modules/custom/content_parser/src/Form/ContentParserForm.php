...
class ContentParserForm extends EntityForm {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, EntityTypeBundleInfoInterface $entity_type_bundle_info, FieldLoaderService $field_loader, QueueInterface $queue) {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('queue')->get('queue_parser')
    );
  }
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['use_sitemap'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Использовать sitemap.xml'),
      '#default_value' => $this->entity->isSitemap()
    ];
    ...
    $form['start_url'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="use_sitemap"]' => ['checked' => false],
        ],
      ],
    ];
    ...
    $form['sitemap'] = [
      '#type' => 'textfield',
      '#title' => 'Путь к sitemap файлу',
      '#default_value' => $this->entity->getSitemap(),
      '#states' => [
        'visible' => [
          ':input[name="use_sitemap"]' => ['checked' => true],
        ],
      ],
    ];
  ...
  protected function buildFieldsInterface(array &$form, FormStateInterface $form_state, $entity_type, $bundle) {
    ...
    $form['entity_wrapper']['details'] = [
      ...
      <p>
        ...
        <code>_content_parser_retrieve_images($doc, $query, $attr = "src")</code>
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['to_queue'] = [
      '#type' => 'submit',
      '#value' => $this->t('Отправить в queue'),
      '#submit' => ['::toQueue'],
    ];
   ...
   * {@inheritdoc}
   */
  public function toQueue(array $form, FormStateInterface $form_state) {
    $options = $this->entity->evalInitCode();
    $urls = $this->entity->getStartUrls();
  ...
  public function parseUrl($url, $depth, $results, $options, $last, array &$context) {
    ...
    $entity->processUrl($url, $options, function($result) use ($context) {
