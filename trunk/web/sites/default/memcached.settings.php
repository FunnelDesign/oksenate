...
/**
 * @file
 * Include this file in settings.php to enable memcached
 */

$settings['memcache']['servers'] = ['localhost:11211' => 'default'];
$settings['memcache']['bins'] = ['default' => 'default'];
$settings['memcache']['key_prefix'] = 'sen_';

//Aquia memcached settings, altered with last module recommendations in readme.txt
